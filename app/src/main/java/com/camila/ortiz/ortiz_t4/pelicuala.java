...
public class pelicuala {

    String nombre,fecha_de_estreno,tienda_1,tienda_2,tienda_3,imagen;
    Integer vistas;

    public pelicuala(String nombre, String fecha_de_estreno, String tienda_1, String tienda_2, String tienda_3, String imagen, Integer vistas) {
        this.nombre = nombre;
